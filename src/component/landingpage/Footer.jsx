...
const LINKS = [
  {
    title: "Lokasani",
    items: ["Tentang Lokasani", "Artikel", "Testimony"],
  },
  {
    title: "Jadilah Creator",
    items: ["Product Creator", "Event Creator"],
  },
  {
    title: "Bantuan",
    items: ["Dukung Kami", "Kontak Kami"],
  },
];
      ...
      <footer className="relative w-full">
        <div className="mx-auto px-8">
              ...
              {LINKS.map(({ title, items }) => (
                <ul key={title}>
                  <Typography
                    variant="small"
                    color="blue-gray"
                    className="mb-3 text-[23px] font-medium opacity-40"
                  >
                    {title}
                  </Typography>
                  {items.map((link) => (
                    <li key={link}>
                      <Typography
                        ...
                        href="#"
                        color="gray"
                        className="py-1.5 text-[15px] font-normal transition-colors hover:text-blue-gray-900"
                      >
                        {link}
                      </Typography>
                    </li>
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
            ...
            <div className="flex gap-4 text-black sm:justify-center text-[20px] font-semibold">
              <p>Terms</p>
              <p>Privacy</p>
              <p>Cookies</p>
            </div>
              ...
              <div className="h-12 w-12">
                ...
                >
                  <svg
                    ...
                    className="h-7 justify-content items-center "
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <Typography
            variant="small"
            className="py-8 text-center text-[15px] font-normal text-blue-gray-900 md:mb-0"
          >
            &copy; {currentYear}{" "}
